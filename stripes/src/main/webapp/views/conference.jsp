		...
		<div class="panel panel-default">
			...
			<table class="table">
				...
				<tr class="conferences">
					...
					<td>${actionBean.conference.start}</td>
				</tr>

				<tr class="conferences">
					<td><label><fmt:message key='conf.title'  /></label></td>
					<td>${actionBean.conference.title}</td>
				</tr>
				<tr class="conferences">
					<td><label><fmt:message key='conf.description'  /></label></td>
					<td>${actionBean.conference.description}</td>
				</tr>
				<tr class="conferences">
					<td><label><fmt:message key='conf.location'  /></label></td>
					<td>${actionBean.conference.location}</td>
				</tr>
				<tr class="conferences">
				...
				<tr class="conferences">
					...
					<td>${actionBean.conference.registrationDeadline}</td>
				</tr>
				<tr class="conferences">
				...
				<tr class="conferences">
					...
					<td>${actionBean.conference.tags}</td>
				</tr>
			</table>
		</div>
	</aside>
